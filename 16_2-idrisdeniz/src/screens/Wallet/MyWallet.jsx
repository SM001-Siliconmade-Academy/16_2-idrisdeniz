...
const MyWallet = () => {
  return (
    <View style={styles.container}>
      <Text style={styles.topText}>TOPLAM PARACIK</Text>
      ...
      <View style={styles.midMenu}>
        ...
        <View style={styles.midMenuPart2}>
          ...
          <Text style={styles.textMenuText2}>HEDİYE PARACIK</Text>
        </View>
        <View style={styles.midMenuPart2}>
          <Text style={styles.textMenu2}>0,00</Text>
          <Text style={styles.textMenuText2}>AKARYAKIT PARACIK</Text>
        </View>
      </View>
