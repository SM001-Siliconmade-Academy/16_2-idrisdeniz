    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.topArea}>
        ...
        <Text style={styles.topText2}>
          ...
          <Text style={{ fontWeight: "bold" }}> email adresini</Text> ve
          <Text style={{ fontWeight: "bold" }}> parolanı </Text>
      ...
      <View style={styles.midArea}>
        ...
        <Pressable onPress={handlePress}>
          <Text style={styles.bottomText}>Zaten üye misiniz? Giriş Yapın</Text>
        </Pressable>
      </View>
    </SafeAreaView>
  );
